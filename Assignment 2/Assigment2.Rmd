...
a =TF.Identification.plot(x,TF.fit)
```
...
```{r, echo = FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.dim=c(5,3), fig.cap='Diferencia Modelaje'}
# Check fitted
...
# Check fitted
autoplot(y, series = "Real")+
  forecast::autolayer(fitted(sarima.fit), series = "Fitted")+
  forecast::autolayer(fitted(sarima2.fit), series = "Fitted")
```
