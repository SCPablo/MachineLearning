...
Da la sensación de existir bastantes valores atípicos, veamoslo:
...
```{r}
transformResults <- resamples(list(lr = LogReg.fit, lr2 = LogReg2.fit, knn = knn.fit, tree = tree.fit, tree2 = tree2.fit, svm = svm.fit, mlp = mlp.fit, mlp2 = mlp2.fit, rf = rf.fit ))
